...
This Privacy Policy describes how Roblox UGC Creator (the "App") collects, uses, and shares information.

## 1) Information We Collect
We collect the following categories of information:
- **Account information**: Email address and basic profile fields from Supabase Auth.
- **Roblox OAuth data**: Roblox user ID, username, avatar URL, and OAuth tokens.
- **User content**: AI prompts, generated 3D assets, textures, and related metadata.
- **Usage data**: Basic logs about feature usage and job status updates.
...
## 4) Data Retention
We retain account data and generated assets while your account is active.
